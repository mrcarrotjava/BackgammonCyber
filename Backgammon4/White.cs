...
namespace Backgammon4
{
    public class White : View
    {
        ...
        Bitmap bitmap;
        public White(int x, int y, Context c) : base(c)
        {
            this.context = c;
            this.x = x;
            this.y = y;
            this.bitmap = Android.Graphics.BitmapFactory.DecodeResource(
            Application.Context.Resources, Resource.Drawable.White);
        ...
        {
            Drawable w;
            w = ContextCompat.GetDrawable(context, Resource.Drawable.White);
            w.SetBounds((int)(x - 20), (int)((y - 20)), (int)(x + 20), (int)(y + 20));
            w.Draw(canvas);
        }
        public void draw_loc(Canvas canvas, int i, int j, int count)
        {
            var drawable = context.GetDrawable(Resource.Drawable.White);
            Drawable w;
